...
jetmetUncertainties2017All = lambda : jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V6_MC", [x for x in jesUncertaintySources if not re.match("Time",x)], redoJEC=True)
